    ...
    <div id="distributors-view" className="space-y-6 max-w-7xl mx-auto">
          ...
          >
            <div>
              <div className="flex items-center justify-between pb-2 border-b border-slate-800">
                <h3 className="font-bold text-slate-100 text-sm">{dist.name}</h3>
      ...
      >
        <form onSubmit={handleCreateDistributor} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-1">العنوان والمقر:</label>
            <input
              type="text"
          ...
          <div className="flex gap-2 pt-3">
            <button
              ...
              className="flex-1 bg-sky-500 hover:bg-sky-400 text-slate-950 font-black py-2.5 rounded-xl text-xs transition-all shadow-md"
            >
              حفظ الموزع
            </button>
            <button
